...
- [ ] 방화벽(UFW 또는 firewalld) 활성화 및 `20022/tcp`, `15034/tcp`만 허용 내역
...
| `api_keys`                | `agent-core`   | R/W ONLY |
| `/var/log/agent-app`      | `agent-core`   | R/W ONLY |
...
- `monitor.log`를 분석해 CPU/MEM/DISK의 **평균/최대/최소**와 **샘플 수**를 콘솔로 출력한다.
